...
const INDEX: SearchResult[] = [
  ...
  { title: 'Horario de check-in', description: 'El check-in es a partir de las 14:00 h', route: '/faq?q=check-in', category: 'FAQ' },
  { title: 'Horario de check-out', description: 'El check-out es antes de las 12:00 h', route: '/faq?q=check-out', category: 'FAQ' },
  { title: 'Wifi gratuito', description: 'El hostal dispone de wifi gratuito en todas las habitaciones', route: '/faq?q=wifi', category: 'FAQ' },
  { title: 'Mascotas', description: 'Se admiten mascotas de pequeño tamaño con suplemento', route: '/faq?q=mascota', category: 'FAQ' },
  { title: 'Cancelación gratuita', description: 'Cancelación sin cargo hasta 48h antes de la llegada', route: '/faq?q=cancelación', category: 'FAQ' },
  { title: 'Desayuno', description: 'Información sobre el desayuno en el hostal', route: '/faq?q=desayuno', category: 'FAQ' },
  { title: 'Aparcamiento parking', description: 'Opciones de aparcamiento cercanas al hostal', route: '/parking', category: 'FAQ' },
  { title: 'Descuento reserva directa', description: '15% de descuento al reservar en nuestra web', route: '/reserva', category: 'Reservas' },
  { title: 'Ascensor', description: 'El hostal dispone de 2 ascensores hasta la 3ª planta', route: '/faq?q=ascensor', category: 'FAQ' },
  { title: 'Aire acondicionado', description: 'Todas las habitaciones tienen aire acondicionado', route: '/faq?q=aire', category: 'FAQ' },
